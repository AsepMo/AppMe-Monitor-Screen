...
public class ImageTransmogrifier implements ImageReader.OnImageAvailableListener {
    public static String TAG = ImageTransmogrifier.class.getSimpleName();
    private final int width;
    private final int height;
    private final ImageReader imageReader;
    private final MonitorScreenService svc;
    private Bitmap latestBitmap=null;

    public ImageTransmogrifier(MonitorScreenService svc) {
        this.svc = svc;
