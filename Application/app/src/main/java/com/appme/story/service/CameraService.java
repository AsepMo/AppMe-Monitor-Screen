...
import com.appme.story.engine.app.commons.connections.JpegFactory;
import com.appme.story.engine.app.commons.connections.MjpegServer;
        ...
        SurfaceHolder.Callback callback = new SurfaceHolder.Callback() {
            public void surfaceCreated(SurfaceHolder holder) {
                ...
                if (mCamera == null) {
                    ...
                    Toast.makeText(CameraService.this, getString(R.string.action_camera_cannot_open),
