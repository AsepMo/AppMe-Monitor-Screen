...
public class MjpegServer extends SimpleServer {
    public static String TAG = MjpegServer.class.getSimpleName();
    ...
    protected void handleConnection(Socket socket) throws IOException {
        ...
        if (fileName.equals("/screen_stream.mjpeg")) {
            sendStream(out);
    ...
    private void sendDefault(OutputStream out) throws IOException {
        String content = "<html>" +
            ...
            "<body><img src='/screen_stream.mjpeg' alt='Camera is not available.' /></body>" +
            "</html>";
        String header = "HTTP/1.0 200 OK\r\n" +
